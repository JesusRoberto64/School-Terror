...
onready var bullet_emitters_base : Spatial = $BulletsEmitters
onready var bullets_emitters = $BulletsEmitters.get_children()
...
func init(_fire_point: Spatial, _bodies_to_exclude: Array):
	...
	for bullet_emitter in bullets_emitters:
...
func attack(attack_input_just_pressed : bool, attack_input_held : bool):
	...
	for bullet_emitter in bullets_emitters: 
		bullet_emitter.fire()
	bullet_emitters_base.global_transform  = start_Traform
	anim_player.stop()
